...
public class QueueSimulator {
    ...
    public void conclussion(double simulationTime){
        ...
        System.out.println("Total time taken to serrve the customers : " + totalTimeToSerrveCustomers);
        System.out.println("Average time to serrve the customers : " + averageTimeToServeEachCustomer +"second");
    }
}
